...
- 예시: 2 6 2 2 -> 기준값: 12/4 = 3
    - [0] 은 [1] 로부터 1개 받는다 -> 3 5 2 2
    - [1] 은 [2] 에게 2개 준다 -> 3 3 4 2
    - [2] 은 [1] 에게 1개 준다 -> 3 3 3 3
- 예시: 2 2 2 6 -> 기준값: 12/4 = 3
    - [0] 은 [1] 로부터 1개 받는다 -> 3 1 2 6
    - [1] 은 [2] 로부터 2개 받는다 -> 3 3 0 6
    - [2] 은 [3] 로부터 3개 받는다 -> 3 3 3 3
- 예시: 1 1 4 6 -> 기준값: 12/4 = 3
    - [0] 은 [1] 로부터 2개 받는다 -> 3 -1 4 6
    - [1] 은 [2] 로부터 4개 받는다 -> 3 3 0 6
    - [2] 은 [3] 로부터 3개 받는다 -> 3 3 3 3
[오답]
- 처음에 사용했던 방식
...
- int 써서 틀렸어서 long 씀
*/
public class Baekjoon24938_키트_분배하기 {
